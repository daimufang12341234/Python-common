...
# Iterate over all key-value pairs in section
for key, value in config.SECTION.items():
    print(key, value)
```

For details, see [ini_config/读取ini配置文件公用.md](ini_config/读取ini配置文件公用.md)
